...
extension Pokemon: PokemonProtocol{
    ...
    func pokeDetails() -> String {
        let details: String = "The pokemon's name is \(name!). It is described as having a weight of \(weight!) lbs and a height of \(height!). It is a \(type!) type pokemon and has an attack value of \(attack!) and defense value of \(defense!)."
        return details
    }
}
